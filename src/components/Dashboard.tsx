...
const Dashboard = () => {
    ...
    const [dropdownOpen, setDropdownOpen] = useState({ pages: false, sales: false });
                        ...
                        <div className="flex justify-start items-center">
                            ...
                            <a href="https://flowbite.com" className="flex items-center justify-between mr-4">
                                <Image
                                    ...
                                    height={500}
                                />
                                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Nutron</span>
                            </a>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    <span className="flex-1 ml-3 text-left whitespace-nowrap">Coin</span>
                                </button>
                                {dropdownOpen.pages && <ul className="pl-8 space-y-2 text-sm"> {/* Add dropdown content */}</ul>}
                            </li>
                            <li>
                                <button
                                    type="button"
